...
import {Courseheader, Cognitivo, Grades} from './Report'
import {
  createBrowserRouter,
...
const Courses = () => {
  ...
  return(
    <div class="flex flex-col items-start md:items-start align-middle mt-3 mx-10 w-44 ">
      <button class="text-violet-950 bg-cyan-400 rounded-full px-7 py-1 w-44  text-center my-3" onClick={() => setToggle(!toggle)}>Classes</button>
...
function Report(){
  return(
    <div class="w-full bg-violet-950/50 rounded-lg mx-4 px-5 pb-5">
